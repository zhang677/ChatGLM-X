...
ROOT = "/home/nfs_data/zhanggh/chatglm/figures"
    ...
    for dtype in [
        ...
        for backward in [False]:
            ...
            for activation in activations:
                ...
                pretty_plot(results, title, "TFlops/s", filename=os.path.join(ROOT, title + ".png"), dash_key="pytorch")


activations = [Activation.ReLU, Activation.LeakyReLU, Activation.GeLU] #  + [None]  # type: ignore
